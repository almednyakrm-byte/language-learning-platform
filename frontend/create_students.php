    ...
    <div class="max-w-md mx-auto mt-10 p-4 bg-white rounded-lg shadow-md">
        ...
        <form id="create-student-form">
            ...
            <div class="mb-4">
                ...
                <input type="date" id="date_of_birth" name="date_of_birth" class="block w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            </div>
            <button type="submit" class="w-full p-2 text-white bg-orange-300 hover:bg-orange-400 rounded-lg focus:ring-orange-300 focus:border-orange-300">Create Student</button>
        </form>
    </div>
